...
typedef int (*tCmpEstudiantes) (tEstudiantes*, tEstudiantes*);
...
/********************************************************************************/
void mergeArchivosAlumnos(FILE *file1, FILE *file2, FILE *fileOut, int (*comparar)(const void *, const void *)){
    rewind(file1);
    rewind(file2);

    unsigned tamEstructura = sizeof(tEstudiantes);
...
int main(){
    ...
    printf("\n**************** MERGE ****************\n");
    mergeArchivos(archivo_1, archivo_2, archivo_3, compararNota);
